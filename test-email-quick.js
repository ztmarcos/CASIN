...
async function testEmailSending() {
  ...
  try {
    const testData = {
      ...
      subject: '🧪 Test Email - CASIN Seguros System (Lorena)',
      htmlContent: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; line-height: 1.6;">
          ...
          <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding: 30px; border-radius: 15px; color: white; text-align: center;">
            ...
            <p style="font-size: 18px; margin: 20px 0;">Este es un correo de prueba desde Lorena para verificar el funcionamiento del sistema de envío de correos de CASIN Seguros.</p>
