...
/**
 * Test Recordatorios Automáticos - CASIN Seguros
 * Prueba el sistema de 3 recordatorios automáticos para vencimientos y pagos parciales
 */
...
async function testRecordatoriosAutomaticos() {
  try {
    console.log('🎯 ========================================');
    console.log('🎯 TEST RECORDATORIOS AUTOMÁTICOS');
    console.log('🎯 ========================================');
    console.log('');
    
    // Datos de prueba para Vencimientos
    const testPolicyVencimientos = {
      numero_poliza: 'TEST-VENC-001',
    ...
    // Datos de prueba para Pagos Parciales
    const testPolicyPagosParciales = {
      numero_poliza: 'TEST-PARCIAL-001',
      nombre_contratante: 'María González López',
      email: 'ztmarcos@gmail.com',
      fecha_proximo_pago: '2025-01-20',
      forma_pago: 'MENSUAL',
...
if (require.main === module) {
  testRecordatoriosAutomaticos().catch(error => {
