...
const Weather = () => {
  ...
  useEffect(() => {
    const getLocation = () => {
      ...
      navigator.geolocation.getCurrentPosition(
        (position) => {
          ...
          // Get city name when coordinates are received
    ...
    const fetchCityName = async (lat, lon) => {
      try {
        ...
        setCityName(city || 'Ubicación desconocida');
      } catch (error) {
  ...
  console.log('Estado del renderizado:', { loading, error, weather, location, cityName });
